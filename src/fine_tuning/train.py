    ...
    for DATE_RANGE in CANDIDATE_DATE_RANGES:
        ...
        for selected_model_name in CANDIDATE_MODELS:
            ...
            if os.environ.get('SDP_USE_IN2','0') == '1':
                ...
                model = build_model_from_config_in2(selected_config, device, strict=True)
            else:
            ...
            X_mean, X_std = make_blended_scaler(
                offline_mean, offline_std, real_iv_tensor, offline_weight=offline_weight_for(selected_model_name)
            )
